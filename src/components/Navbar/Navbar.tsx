...
import { configuracion, consultas, menuCelular, perfil, telemarketers } from './logs'
    ...
    return (
        <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            <Popover className="relative mt-1">
                {({ open, close }) => (
                    <>
                        <NavbarGroupButton classNames={classNames} open={open} title={'Consultas'} />
                        ...
                        >
                            <Popover.Panel className="absolute z-10 -ml-4 mt-7 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                                <GroupPrincipalPanel dataOptions={consultas} close={close} />
                            </Popover.Panel>
                        </Transition>
                    </>
                )}
